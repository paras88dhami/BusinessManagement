...
export const ledgerEntriesTable = tableSchema({
  ...
  columns: [
    ...
    { name: "settled_against_entry_remote_id", type: "string", isOptional: true, isIndexed: true },
    { name: "linked_document_remote_id", type: "string", isOptional: true, isIndexed: true },
